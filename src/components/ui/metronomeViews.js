        ...
        <Card>
            ...
            <Card.Body>
                <div className="mb-2 d-flex flex-row justify-content-between">
                    <Dropdown onSelect={(ek) => { console.log("Selected params:", ek); }}>
                        ...
                        <Dropdown.Menu>
                            ...
                            <Dropdown.Item eventKey="8/8" active={"9/8" === metronomeState.timesig}>9/8</Dropdown.Item>
                ...
                <div className="mb-2">
                    <RangeViewController label="Volume" name="volume" min={-35} max={20} step={1} value={metronomeState.bpm} paramIdx={21} dispatch={reducer} onChange={(v) => reducer({ type: "setMetronome", value: {...metronomeState, bpm:v} })} apiCallback={(v, r) => { PtqApi.setMetronome({...metronomeState, bpm: v}, r) }} />
                </div>
                <div className="mb-2">
                    <RangeViewController label="Tempo" name="bpm" min={24} max={360} step={1} value={metronomeState.volume_db} paramIdx={21} dispatch={reducer} onChange={(v) => reducer({ type: "setMetronome", value: {...metronomeState, volume_db:v} })} apiCallback={(v, r) => { PtqApi.setMetronome({...metronomeState, volume_db: v}, r) }} />
                </div>
            </Card.Body>
        </Card>
    )
