...
import { FractionRangeParameterViewController, NegativeRangeParameterViewController, RangeParameterViewController } from "./inputs";
...
const SpectrumProfile = ({ context: ctx, reducer }) => {
    return (
        <>
            <NegativeRangeParameterViewController label="Profile #1" name="profile1" min={-15} max={15} step={0.01} param={ctx.instrumentParameters.spectrumProfile1} dispatch={reducer} apiCallback={PtqApi.setParameterAsText} />
            <NegativeRangeParameterViewController label="Profile #2" name="profile2" min={-15} max={15} step={0.01} param={ctx.instrumentParameters.spectrumProfile2} dispatch={reducer} apiCallback={PtqApi.setParameterAsText} />
            <NegativeRangeParameterViewController label="Profile #3" name="profile3" min={-15} max={15} step={0.01} param={ctx.instrumentParameters.spectrumProfile3} dispatch={reducer} apiCallback={PtqApi.setParameterAsText} />
            <NegativeRangeParameterViewController label="Profile #4" name="profile4" min={-15} max={15} step={0.01} param={ctx.instrumentParameters.spectrumProfile4} dispatch={reducer} apiCallback={PtqApi.setParameterAsText} />
            <NegativeRangeParameterViewController label="Profile #5" name="profile5" min={-15} max={15} step={0.01} param={ctx.instrumentParameters.spectrumProfile5} dispatch={reducer} apiCallback={PtqApi.setParameterAsText} />
            <NegativeRangeParameterViewController label="Profile #6" name="profile6" min={-15} max={15} step={0.01} param={ctx.instrumentParameters.spectrumProfile6} dispatch={reducer} apiCallback={PtqApi.setParameterAsText} />
            <NegativeRangeParameterViewController label="Profile #7" name="profile7" min={-15} max={15} step={0.01} param={ctx.instrumentParameters.spectrumProfile7} dispatch={reducer} apiCallback={PtqApi.setParameterAsText} />
            <NegativeRangeParameterViewController label="Profile #8" name="profile8" min={-15} max={15} step={0.01} param={ctx.instrumentParameters.spectrumProfile8} dispatch={reducer} apiCallback={PtqApi.setParameterAsText} />
        </>
    )
}